 ...
 * @created 25.02.2012
 */
public class S_Skill_Learn_List extends ServerPacket
{
	private static final ServerPacket instance = new S_Skill_Learn_List();

	public static S_Skill_Learn_List getInstance(Array<SkillLearn> skills, Player player)
	{
		S_Skill_Learn_List packet = (S_Skill_Learn_List) instance.newInstance();
	...
	{
		return ServerPacketType.S_SKILL_LEARN_LIST;
	}
