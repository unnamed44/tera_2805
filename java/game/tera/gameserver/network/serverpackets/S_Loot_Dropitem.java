 ...
 * @author Ronn
 */
public class S_Loot_Dropitem extends ServerPacket
{
	private static final ServerPacket instance = new S_Loot_Dropitem();

	public static S_Loot_Dropitem getInstance(Character character, ItemInstance item)
	{
		S_Loot_Dropitem packet = (S_Loot_Dropitem) instance.newInstance();
	...
	{
		return ServerPacketType.S_LOOT_DROPITEM;
	}
