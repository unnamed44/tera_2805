 ...
 * @author Ronn
 */
public class S_Spawn_Bonfire extends ServerPacket
{
	private static final ServerPacket instance = new S_Spawn_Bonfire();

	public static S_Spawn_Bonfire getInstance(WorldObject object)
	{
		S_Spawn_Bonfire packet = (S_Spawn_Bonfire) instance.newInstance();
	...
	{
		return ServerPacketType.S_SPAWN_BONFIRE;
	}
