 ...
 * @author Ronn
 */
public class S_Creature_Change_Hp extends ServerPacket
{
	/** просто прибавка */
	...
	private static final ServerPacket instance = new S_Creature_Change_Hp();
	
	public static S_Creature_Change_Hp getInstance(Character player, Character attacked, int countChange, int type)
	{
		S_Creature_Change_Hp packet = (S_Creature_Change_Hp) instance.newInstance();
	...
	{
		return ServerPacketType.S_CREATURE_CHANGE_HP;
	}
