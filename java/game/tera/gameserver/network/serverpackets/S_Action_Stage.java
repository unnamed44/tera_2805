 ...
 * @created 31.03.2012
 */
public class S_Action_Stage extends ServerPacket
{
	private static final ServerPacket instance = new S_Action_Stage();

	public static S_Action_Stage getInstance(Character caster, int skillId, int castId, int state)
	{
		S_Action_Stage packet = (S_Action_Stage) instance.newInstance();
	...
	{
		return ServerPacketType.S_ACTION_STAGE;
	}
