 ...
 * @author Ronn
 */
public class S_Npc_Location extends ServerPacket
{
	private static final ServerPacket instance = new S_Npc_Location();

	public static S_Npc_Location getInstance(Character actor, MoveType type, float x, float y, float z, int heading, float targetX, float targetY, float targetZ)
	{
		S_Npc_Location packet = (S_Npc_Location) instance.newInstance();
