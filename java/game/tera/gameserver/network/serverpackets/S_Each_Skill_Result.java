 ...
 * @author Ronn
 */
public class S_Each_Skill_Result extends ServerPacket
{
	...
	private static final ServerPacket instance = new S_Each_Skill_Result();
	
	public static S_Each_Skill_Result getInstance(Character attacker, Character attacked, AttackInfo info, Skill skill, int type)
	{
		S_Each_Skill_Result packet = (S_Each_Skill_Result) instance.newInstance();
	...
	public static S_Each_Skill_Result getInstance(Character attacker, Character attacked, int damageId, int damage, boolean crit, boolean owerturned, int type)
	{
		S_Each_Skill_Result packet = (S_Each_Skill_Result) instance.newInstance();
	...
	{
		return ServerPacketType.S_EACH_SKILL_RESULT;
	}
