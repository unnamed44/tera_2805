 ...
 * @author Ronn
 */
public class S_Creature_Rotate extends ServerPacket
{
	private static final ServerPacket instance = new S_Creature_Rotate();

	public static S_Creature_Rotate getInstance(Character character, int newHeading, int time)
	{
	...
	{
		return ServerPacketType.S_CREATURE_ROTATE;
	}
