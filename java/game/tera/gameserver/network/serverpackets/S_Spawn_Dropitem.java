 ...
 * @author Ronn
 */
public class S_Spawn_Dropitem extends ServerPacket
{
	private static final ServerPacket instance = new S_Spawn_Dropitem();

	public static S_Spawn_Dropitem getInstance(ItemInstance item)
	{
		S_Spawn_Dropitem packet = (S_Spawn_Dropitem) instance.newInstance();
	...
	{
		return ServerPacketType.S_SPAWN_DROPITEM;
	}
