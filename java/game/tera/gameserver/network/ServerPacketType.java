...
public enum ServerPacketType
{
	...
	S_EMPTY_GUILD_WINDOW(0xA667),
	S_REPLY_GUILD_LIST(0x6A16),
	S_REQUEST_GUILD_INFO_BEFORE_APPLY_GUILD(0x76BD),
	S_VIEW_MY_GUILD_WAR(0xD08E),
	S_GUILD_NAME(0x93D5),
	S_GUILD_INFO(0xB12C),
	S_GUILD_MEMBER_LIST(0xBF5A),
	S_GUILD_APPLY_LIST(0xDC31),
	S_TOTAL_GUILD_WAR_DATA(0x97C4),
	S_SPAWN_COLLECTION(0x7EF0),
	S_DESPAWN_COLLECTION(0xC9E6),
	S_COLLECTION_PICKSTART(0x7029),
	S_COLLECTION_PICKEND(0xE469),
	S_PLAYER_CHANGE_PROF(0x606D),
	S_COLLECTION_PROGRESS(0xA4BC),
	S_USER_STATUS(0x6EDA),
	S_UNION_STATE_INFO(0x7364),
	S_ADD_GUILD_GROUP(0xA359),
	S_REMOVE_GUILD_GROUP(0xAD58),//need to add
	S_GUILD_ANNOUNCE(0xD993),
	S_ANSWER_INTERACTIVE(0x9791),
	S_CHANGE_GUILD_CHIEF(0x8B24),
	S_GUILD_HISTORY(0xC72E),
	S_UNION_CHANGE(0x6626),
	S_UNION_MY_UNION(0x5161),
	S_VIEW_UNION_INFO(0xA2DE),
	S_UNION_CHANGE_TAXRATE(0x6E03),
	S_UNION_CHANGE_NOTICE(0xFCDC),
	...
	S_SYSTEM_MESSAGE_LOOT_ITEM(0xE87C),
