...
public final class WorldZone
{
	...
	{
		return "S_Load_Topo maxX = " + maximumX + ", minX = " + minimumX + ", maxY = " + maximumY + ", minY = " + minimumY + ", maxZ = " + maximumZ + ", minZ = " + minimumZ + ", zoneId = " + zoneId + ", zone = " + zone + ", respawnPoints = " + Arrays.toString(respawnPoints);
	}
}
